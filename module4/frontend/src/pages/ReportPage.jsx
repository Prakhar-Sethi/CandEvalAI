          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1 leading-relaxed">
                Our HR team will review your submission and get back to you within <span className="text-slate-200 font-medium">3–5 business days</span>. Please keep an eye on your email for further communication.
              </p>
            </div>
          </div>
